...
export default function SpecializedTheraphy() {
  useEventListeners()
      ...
      <div className="content">
        ...
        <main>
          ...
          <section className="description-title-desc">
            <h2>About our Sports Injuries Curing and Expertise</h2>
            <p>
          ...
          <section className="description-title-desc">
            <h2>Specialized Training, Personalized Care</h2>
            <p>
              When performed by licensed practitioners, acupuncture is generally
              safe and minimally invasive. It is tailored to each individual’s
              needs, with sessions designed to address specific health concerns.
              Beyond physical benefits, many patients report improved mental
              well-being, making acupuncture a holistic option for both body and
              mind health.
            </p>
          </section>
        </main>
