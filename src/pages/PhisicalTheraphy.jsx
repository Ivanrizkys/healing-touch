    ...
    <>
      ...
      <div className="content">
        ...
        <section className="description-title-desc">
          <h2>About our Physiotherapy and expertise</h2>
          <p>
            Physiotherapy, also known as physical therapy, is a healthcare
            discipline focused on improving physical function and mobility,
            preventing disabilities, and promoting overall well-being. It uses
            non-invasive treatments, such as therapeutic exercises, manual
            therapy, and electrotherapy, to help individuals recover from
            injuries, surgeries, or chronic conditions. Physiotherapy is widely
            used to manage musculoskeletal issues, neurological disorders,
            cardiovascular rehabilitation, and sports injuries.
          </p>
          <p>
            A physiotherapist designs personalized treatment plans tailored to
            the patient’s specific needs, considering factors like their medical
            history and rehabilitation goals. Treatments often include exercises
            to strengthen muscles, improve flexibility, and enhance range of
            motion. Techniques like massage therapy, heat or cold application,
            and advanced methods such as ultrasound therapy and dry needling are
            commonly employed to reduce pain and inflammation.
          </p>
          <p>
            Physiotherapy not only aids in recovery but also plays a vital role
            in prevention. It educates patients on posture correction, injury
            prevention, and ergonomic practices to maintain long-term physical
            health. Whether helping athletes recover from injuries, managing
            chronic conditions like arthritis, or assisting stroke patients in
            regaining mobility, physiotherapy is essential in enhancing the
            quality of life and fostering independence.
          </p>
        </section>
        <section className="description-title-desc">
          <h2>Healing Touch Physiotherapy Experts</h2>
          <p>
            Physiotherapy not only aids in recovery but also plays a vital role
            in prevention. It educates patients on posture correction, injury
            prevention, and ergonomic practices to maintain long-term physical
...
export default PhysicalTheraphy;
